                ...
                <div class="wrap-box">
                    ...
                    <div class="left-925">
                        <div class="goods-box clearfix">
                            <!--商品图片-->
                            <div class="pic-box">
                                <detail-left :imglist="detail.imglist"></detail-left>
                            </div>
                            <!--/商品图片-->
                                        ...
                                        <li>
                                            ...
                                            <div class="inner-box">
                                                <div class="info"><span>匿名用户</span>
                                                    <span>2017/10/23 14:58:59</span></div>
                                                <p>testtesttest</p>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div class="inner-box">
                                                <div class="info"><span>匿名用户</span>
                                                    <span>2017/10/23 14:59:36</span></div>
                                                <p>很清晰调动单很清晰调动单</p>
                                            </div>
                                        </li>
                                    </ul>
...
<script>
    import DetailLeft from "./detailChildren/DetailLeft.vue";
    import DetailCenter from "./detailChildren/DetailCenter.vue";
    ...
    export default{
        ...
        created () {
            // 当组件初始化完毕时，获取url中传递过来的商品id，并作为参数传递给getDetail函数使用
